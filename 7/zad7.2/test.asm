...
=> 0x080484c1 <+6>:	mov    ecx,DWORD PTR [ebp+0x8] ; c
   ...
   0x08048503 <+72>:	mov    ecx,DWORD PTR [ebp-0x4] ; ecx iloczyn
   0x08048506 <+75>:	mov    edx,0x4ec4ec4f ; edx= liczba
   0x0804850b <+80>:	mov    eax,ecx ; eax iloczyn
   0x0804850d <+82>:	mul    edx ; iloczyn*=liczba
   0x0804850f <+84>:	mov    eax,edx; eax = iloczyn
   0x08048511 <+86>:	shr    eax,0x3; eax = iloczyn >>3
   0x08048514 <+89>:	imul   eax,eax,0x1a; iloczyn *=26
   0x08048517 <+92>:	sub    ecx,eax ; iloczyn-= iloczyn2
   0x08048519 <+94>:	mov    eax,ecx; eax = iloczyn
   0x0804851b <+96>:	mov    edx,eax ;edx = iloczyn
